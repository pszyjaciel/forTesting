...
try {
	...
	$.writeln(Exception.name + ' ' + Exception.number + ' in line '
...
// var myDataMergeFieldsProp =
// app.activeDocument.dataMergeProperties.dataMergePreferences.reflect.properties;
...
var myDataMergeTextPlaceholders_anyItem_field = myDataMergeTextPlaceholders_anyItem.field
		.getElements();
...
var myEveryItem = app.activeDocument.dataMergeProperties.dataMergeFields
		.everyItem();
