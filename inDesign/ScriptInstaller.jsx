...
//	g2.spacing = 0;
//	var okButton = g2.add('button', undefined, kOK, {
//		name : 'ok'
//	});
//	var cancelButton = g2.add('button', undefined, kCancel, {
//		name : 'cancel'
//	});
...
//	}
	...
	if (installOption < 2) {
		...
		var file = Folder
				.selectDialog("Please pick your script folder to install");
	}
	if (!file) {
		return
	...
	try {
		file.copy(scriptsFolder.absoluteURI + "/" + file.name);
	} catch (err) {
