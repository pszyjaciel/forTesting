...
with (app.dataMergeOptions) {  app.activeDocument.dataMergeProperties.selectDataSource(myDMFile);
...
//$.writeln (DataMergeTextPlaceholder.reflect.methods);    // wyswietla metody - zle
$.writeln (app.activeDocument.dataMergeProperties.reflect.methods);    // wyswietla metody - poprawnie
...
//$.writeln(app.activeDocument.dataMergeProperties.reflect.properties); //This code gets a list of properties
...
// dm2.reflect.name()  - daje dm2.reflect.name is not a function (blad ze som klamerki)
...
//$.writeln (app.activeDocument.reflect.methods);    // wyswietla metody - poprawnie
...
$.writeln (app.activeDocument.dataMergeProperties.reflect.properties);    // wyswietla metody - poprawnie
//~ properties:
